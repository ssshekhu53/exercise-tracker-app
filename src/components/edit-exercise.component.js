            ...
            <div className="container-fluid">
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        ...
                        <select ref="userInput" required className="custom-select" value={this.state.username} onChange={this.onChangeUsername}>
                            {
                    ...
                    <div className="form-group">
                        <button type="submit" className="btn btn-success">Update Exercise Log</button>
                    </div>
                </form>
            </div>
        );
